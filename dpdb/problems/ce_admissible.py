...
class CEAdmissible(Problem):
    ...
    def candidate_extra_cols(self, node):
        ...
        Here, calculates the value for the extra column (see var2defeat method) as well as the value for counter.
    ...
    def var2extra(self, node, var):
        ...
        # list of all arguments attacked by 'var' within 'node'
        ...
        # TODO: add here case when VAR = 1 (in) ? it should follow already and hence not be necessary
